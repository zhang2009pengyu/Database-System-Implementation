...
int main (int argc, char *argv[]) {
	...
	mySchema->appendAtt (make_pair ("suppkey", make_shared <MyDB_IntAttType> ()));//case 1, case 6
	...
	mySchema->appendAtt (make_pair ("nationkey", make_shared <MyDB_IntAttType> ()));//case 2
	...
	mySchema->appendAtt (make_pair ("comment", make_shared <MyDB_StringAttType> ()));//case 3, case 4, case 5
