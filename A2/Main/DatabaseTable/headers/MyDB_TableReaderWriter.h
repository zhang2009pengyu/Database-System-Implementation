...
private:
	...
	// the table that this reader/writeer is operated on
	MyDB_TablePtr table_;

	// the specified buffer manager
	MyDB_BufferManagerPtr bufferMgr_;

	vector<MyDB_PageReaderWriter> pageRWList_;


	// create a new page reader/writer with a new empty page
	// this new page will append to the table as last page
	void createNewEmptyPageRW ();

	// clear the table content
	// will be called when loading from a text file
	void clear();
