...
public:
    ...
    //
    SortMergeJoin (MyDB_TableReaderWriterPtr leftInput,
    ...
    void mergeRecs (MyDB_RecordPtr leftRec,
                    MyDB_RecordPtr rightRec,
                    vector<MyDB_PageReaderWriter> left,
                    vector<MyDB_PageReaderWriter> right,
                    MyDB_TableReaderWriterPtr output,
                    MyDB_SchemaPtr mySchemaOut);
    int checkSingleAcceptance(func pred,
...
private:
    ...
    vector <MyDB_RecordIteratorAltPtr> getRunlistIter(size_t runSize,
                                                      MyDB_TableReaderWriterPtr tableToSort, string equality);
